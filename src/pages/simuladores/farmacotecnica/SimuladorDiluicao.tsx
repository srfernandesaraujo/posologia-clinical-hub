            ...
            {mode === "serial" && (
              <ResponsiveContainer width="100%" height={280}>
                <BarChart data={serial}>
                  ...
                  <XAxis dataKey="tube" label={{ value: "Tubo", position: "insideBottom", offset: -5 }} stroke="hsl(var(--muted-foreground))" tick={{ fontSize: 10 }} />
                  <YAxis label={{ value: "Concentração", angle: -90, position: "insideLeft" }} stroke="hsl(var(--muted-foreground))" />
