...
export default function SimuladorTestesOrtopedicos() {
  ...
  const { virtualRoomCase, isVirtualRoom: isVR, goBack: vrGoBack, submitResults: submitVRResults, submitted, examProgress, examFeedback, proceedToNext } = useVirtualRoomCase("testes-ortopedicos");
