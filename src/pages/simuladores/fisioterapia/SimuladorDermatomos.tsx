...
export default function SimuladorDermatomos() {
  ...
  const { virtualRoomCase, isVirtualRoom: isVR, goBack: vrGoBack, submitResults: submitVRResults, submitted, examProgress, examFeedback, proceedToNext } = useVirtualRoomCase("dermatomos");
  ...
  return (
    <div className="space-y-6 p-4 md:p-6 max-w-6xl mx-auto">
      ...
      <LabReportPanel benchTitle="Dermátomos e Avaliação Sensitiva" isUnlocked={completedModules.has(4)} experimentSummary={expSummary} isVirtualRoom={isVR} onVRSubmit={handleVRSubmit} vrSubmitted={submitted} />
      {isVR && submitted && (
