...
export default function SimuladorAvaliacaoNutricional() {
  ...
  const { virtualRoomCase, isVirtualRoom: isVR, goBack: vrGoBack, submitResults: submitVRResults, examProgress, examFeedback, proceedToNext } = useVirtualRoomCase("avaliacao-nutricional");
  ...
  return (
    <div className="space-y-6 p-4 md:p-6 max-w-6xl mx-auto">
      ...
      <LabReportPanel benchTitle="Avaliação Nutricional Antropométrica" isUnlocked={completedModules.has(4)} experimentSummary={expSummary} />
    </div>
  );
}
