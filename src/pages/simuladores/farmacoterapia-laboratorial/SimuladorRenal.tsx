...
const BUILT_IN_CASES: RenalCase[] = [
  { title: "Caso 1: Vancomicina em DRC G3", difficulty: "Médio", patient: { name: "Carlos Eduardo", age: 58, weight: 75, sex: "M", specialGroup: ["DRC G3b", "DM2"], diagnosis: "Osteomielite MRSA — ajuste de vancomicina por ClCr" }, scenario: "Homem 58a, DRC G3b (TFG 41), DM2, osteomielite por MRSA. Cr 2.1. Ajustar dose e intervalo.", baseLab: { creatinina: 2.1, ureia: 68, k: 4.8, na: 138, ca: 8.5, fosforo: 5.2, hb: 10.5 }, expectedDrugs: ["Vancomicina"], clinicalTip: "Vancomicina em DRC: vale 15-20 mcg/mL para MRSA. ClCr 30-50: 15mg/kg a cada 24-48h.", references: ["IDSA MRSA 2011", "Rybak MJ 2020"] },
  ...
  { title: "Caso 5: Toxicidade Digitálica por DRC", difficulty: "Difícil", patient: { name: "Seu Benedito", age: 82, weight: 65, sex: "M", specialGroup: ["ICC", "FA", "DRC G4"], diagnosis: "Digoxina 3.2 ng/mL — bradicardia + visão amarelada" }, scenario: "Homem 82a, ICC+FA, digoxina 0.25mg/dia. TFG 29. Náusea, visão amarelada, FC 48. Nível: 3.2 ng/mL.", baseLab: { creatinina: 1.8, ureia: 58, k: 3.2, na: 140, ca: 9.2, fosforo: 4.0, hb: 12.0 }, expectedDrugs: ["Digoxina"], clinicalTip: "Digoxina: 85% renal. Em DRC: 0.0625-0.125mg/dia. Hipocalemia potencializa toxicidade.", references: ["Bauman JL 2006"] },
];
