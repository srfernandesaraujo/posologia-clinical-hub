...
const DRUGS: CoagDrug[] = [
  ...
  // daysToEffect era 6 por engano — o próprio desafio ensina "efeito em ~24h",
  // e com 6 o INR ficava quase parado a semana toda no gráfico.
  { name: "Vitamina K (Fitomenadiona)", class: "Reversor", doseMin: 1, doseMax: 10, doseUnit: "mg EV/VO", doseStep: 1, effects: { inr: -2, ttpa: -5, antiXa: 0, plaquetas: 0, fibrinogenio: 0, dDimero: 0 }, sideEffects: { sangramento: -0.3, hit: 0, osteoporose: 0, necroseCumarinicos: 0, gi: 0 }, daysToEffect: 1 },
