...
export default function SimuladorPeriodontograma() {
  ...
  const { virtualRoomCase, isVirtualRoom: isVR, goBack: vrGoBack, submitResults: submitVRResults, submitted, examProgress, examFeedback, proceedToNext } = useVirtualRoomCase("periodontograma");
  ...
  return (
    <div className="space-y-6 p-4 md:p-6 max-w-6xl mx-auto">
      ...
      <LabReportPanel benchTitle="Periodontograma" isUnlocked={completedModules.has(4)} experimentSummary={expSummary} isVirtualRoom={isVR} onVRSubmit={handleVRSubmit} vrSubmitted={submitted} />
    </div>
  );
}
