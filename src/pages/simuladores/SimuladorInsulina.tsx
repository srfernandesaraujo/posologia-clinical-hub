...
export default function SimuladorInsulina() {
  ...
  const { virtualRoomCase, isVirtualRoom, loading: loadingVR, goBack, submitResults, examProgress, examFeedback, proceedToNext } = useVirtualRoomCase("insulina", BUILT_IN);
