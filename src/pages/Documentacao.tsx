...
const sections = [
  ...
  },
  {
    ...
    icon: DoorOpen,
    description: "Crie salas com PIN para atividades em grupo. Suporta simuladores, laboratórios de pesquisa e casos clínicos em equipe ao vivo, com Analytics completo (decisões, radar, relatório e sinal de risco por aluno) e certificação OSCE ao final de provas multi-estação.",
    items: [
