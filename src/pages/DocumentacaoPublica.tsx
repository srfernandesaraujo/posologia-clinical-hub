...
const sections: DocSection[] = [
  ...
  },
  {
    ...
    items: [
      { q: "O que são os simuladores?", a: "São ambientes interativos que reproduzem cenários clínicos, fisiológicos e bioquímicos, permitindo prática segura de raciocínio. A plataforma conta com mais de 110 simuladores." },
      { q: "Quantas categorias de simuladores existem?", a: "Os simuladores estão organizados em 13 categorias: Farmácia Clínica (17), Fisiologia Humana (11), Bioquímica (10), Farmacologia Básica (8), Farmacotécnica (8), Química Farmacêutica (8), Odontologia (8), Fisioterapia (8), Nutrição (8), Genética (8), Farmacoterapia Laboratorial (8), Formação Docente (7) e Informática em Saúde (1), além de simuladores criados pelo usuário." },
      { q: "O que é o simulador de Prontuário Eletrônico (FHIR)?", a: "É o primeiro simulador da categoria Informática em Saúde: você navega um prontuário clínico longitudinal (2-3 consultas) organizado em abas — Demografia, Problemas, Medicações, Exames e Linha do Tempo. Em cada seção, um botão 'Ver como FHIR' mostra como aquele mesmo dado trafegaria como recurso FHIR real (Patient, Condition, MedicationRequest, Observation, ServiceRequest), em JSON anotado. É pensado para quem quer entender interoperabilidade em saúde na prática, sem precisar programar." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "O que são os Créditos de Educação Continuada?", a: "Na mesma aba 'Competências', ao atingir 70% de maestria ponderada com pelo menos 3 simuladores distintos concluídos numa categoria (trilha), você pode emitir um certificado de trilha concluída em PDF, com um código de verificação público. É um recurso exclusivo do plano Premium, e a elegibilidade é recalculada no servidor a partir do seu histórico real — nunca confiando apenas no que aparece na tela." },
      { q: "O certificado de educação continuada é reconhecido pelos conselhos profissionais (CFF, CRF, CFM)?", a: "Não automaticamente. É um certificado verificável (PDF + verificação pública por código, no mesmo espírito do certificado OSCE), não um Open Badge/Verifiable Credential assinado digitalmente, e a plataforma não tem nenhuma integração com conselhos profissionais. O próprio certificado deixa isso explícito: o reconhecimento formal como crédito de educação continuada depende de um trâmite institucional próprio, fora do escopo da plataforma." },
      { q: "Qual a diferença entre o crédito de educação continuada e o certificado OSCE?", a: "O certificado OSCE é emitido pelo professor e escopado a uma sala/prova específica (Atividade Simulada com várias estações). Já o crédito de educação continuada é emitido pelo próprio aluno, por trilha (categoria de simulador), e cobre qualquer uso da plataforma — dentro ou fora de Salas Virtuais." },
      { q: "Como alguém verifica um crédito de educação continuada?", a: "Acessando /verificar-credito/ seguido do código impresso no certificado — sem precisar de conta ou login. A página mostra nome do aluno, trilha, carga horária, maestria e data de emissão, e avisa se o crédito foi revogado." },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Posso usar laboratórios nas salas?", a: "Sim! As salas suportam tanto simuladores (110+) quanto bancadas do Laboratório Virtual (11). O professor escolhe entre 'Simuladores' ou 'Laboratórios' no momento da criação." },
      ...
      { q: "O que é o certificado OSCE?", a: "Quando o professor monta uma 'Atividade Simulada' (roteiro com várias estações avaliadas) e um aluno completa todas elas, é possível emitir um certificado com a nota final, o desempenho detalhado por competência (agrupado pela mesma categoria usada no Mapa de Competências) e um sinal leve de integridade da prova — quantas vezes o aluno trocou de aba/perdeu o foco ou saiu da tela-cheia durante as estações, sem qualquer uso de webcam. O certificado é gerado em PDF com um código de verificação único e pode ser revogado pelo professor a qualquer momento." },
      { q: "Como alguém verifica se um certificado OSCE é válido?", a: "Acessando /verificar-certificado/ seguido do código impresso no certificado — não é preciso ter conta nem estar logado. A página mostra nome do aluno, prova, nota final, data de emissão e desempenho por competência, e avisa se o certificado foi revogado." },
      { q: "O que é a trilha de raciocínio explicável no Feedback de Simulação?", a: "O Feedback de Simulação é uma ferramenta do professor que conversa sobre o desempenho de uma sala usando modelos pedagógicos (Pendleton, R2C2, SBI, ALOBA, Mini-CEX). Ao clicar em 'Finalizar e salvar avaliação', a IA converte a conversa inteira numa cadeia de critérios auditável: o instrumento pedagógico aplicado, cada critério avaliado com a observação real da sala que fundamentou o julgamento, a referência usada e o veredito, além de um resumo final. Essa cadeia fica salva permanentemente e aparece na lista 'Avaliações salvas nesta sala', podendo ser reaberta a qualquer momento — mesmo depois de recarregar a página." },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { q: "Quais planos estão disponíveis?", a: "Oferecemos Gratuito (com limite diário de calculadoras) e Premium (acesso ilimitado a calculadoras, 110+ simuladores, 11 bancadas de laboratório, jogos, salas virtuais com analytics, formação docente, relatórios PDF e emissão de créditos de educação continuada)." },
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative py-16 md:py-24">
        ...
        <div className="relative container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="text-white/50 mb-8">Encontre respostas sobre todas as funcionalidades da plataforma — calculadoras, 110+ simuladores, 11 bancadas de laboratório, MedView 3D, jogos, formação docente, salas virtuais e mais.</p>
