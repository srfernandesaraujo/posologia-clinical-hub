...
const sections: DocSection[] = [
  ...
  },
  {
    ...
    items: [
      { q: "Quais planos estão disponíveis?", a: "Oferecemos Gratuito (com limite diário de calculadoras) e Premium (acesso ilimitado a calculadoras, 109+ simuladores, 11 bancadas de laboratório, jogos, salas virtuais com analytics, formação docente, relatórios PDF e emissão de créditos de educação continuada)." },
