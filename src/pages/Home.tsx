...
import {
  Stethoscope, Calculator, FlaskConical, Zap, Shield, Users,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              A rotina clínica não pode esperar
            </h2>
            <p className="text-white/50 text-lg max-w-2xl mx-auto">
              Você precisa de respostas rápidas e confiáveis. Nós entregamos exatamente isso.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {painPoints.map((item) => (
              <div
                key={item.problem}
                className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-7 hover:border-emerald-500/20 transition-colors group"
              >
      ...
      <section className="bg-[#0A0F1C] py-20 md:py-28">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Scores e calculadoras que você usa todo dia
            </h2>
            <p className="text-white/50 text-lg max-w-2xl mx-auto">
              De CHA₂DS₂-VASc a Clearance de Creatinina — tudo em um só lugar, 
              com explicação didática e referências atualizadas.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto mb-10">
            {toolExamples.map((tool) => (
              <div
                key={tool.name}
                className="flex items-center gap-4 rounded-2xl border border-white/[0.06] bg-white/[0.03] p-5 hover:border-emerald-500/20 hover:bg-white/[0.05] transition-all"
              >
      ...
      <section className="bg-[#080C18] py-20 md:py-28">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              <span className="inline-block text-xs font-bold tracking-widest text-emerald-400 uppercase mb-4">
                Por que usar o MedCalc Hub?
              </span>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Feito por quem entende a rotina clínica
              </h2>
              <p className="text-white/50 text-lg mb-8">
                Cada ferramenta foi pensada para se encaixar no fluxo de trabalho 
                do profissional de saúde — rápida, precisa e sem distrações.
              </p>
              <Link
                to="/cadastro"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 px-7 py-3.5 text-sm font-bold text-white hover:from-emerald-400 hover:to-teal-500 transition-all shadow-lg shadow-emerald-500/20"
              >
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "Navegue por especialidade ou busque pelo nome do score.",
                icon: Calculator,
              },
              {
                step: "03",
                title: "Obtenha o resultado",
                desc: "Preencha os campos e receba o resultado com interpretação clínica.",
                icon: TrendingUp,
              },
            ].map((item) => (
              <div key={item.step} className="text-center">
                <div className="relative mx-auto mb-5">
                  ...
                  <span className="absolute -top-2 -right-2 text-xs font-black text-emerald-400/30 text-4xl">
                    {item.step}
                  </span>
                </div>
          ...
          <div className="relative rounded-3xl overflow-hidden max-w-4xl mx-auto">
            ...
            <div className="relative p-10 md:p-16 text-center">
              ...
              <p className="text-white/80 text-lg mb-8 max-w-lg mx-auto">
                Junte-se a profissionais que já utilizam o MedCalc Hub 
                para agilizar sua rotina e melhorar o cuidado ao paciente.
              </p>
              <Link
                to="/cadastro"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-8 py-4 text-base font-bold text-emerald-700 hover:bg-white/90 transition-colors shadow-xl"
              >
