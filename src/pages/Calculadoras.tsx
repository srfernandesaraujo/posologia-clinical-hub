...
import { Calculator, Search, Heart, Pill, Syringe, Beaker, Brain, Activity, ShieldAlert, Crown } from "lucide-react";
...
export default function Calculadoras() {
  ...
  const { isPremium, upgradeOpen, setUpgradeOpen, upgradeFeature, recordCalculatorUse, remainingCalculators } = useFeatureGating();
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {(!search || "calculadora de risco cardiovascular".includes(search.toLowerCase())) && (
            <div
              onClick={(e) => handleCalcClick(e, "/calculadoras/risco-cardiovascular")}
