...
const NATIVE_SIMULATORS = [
  ...
  { slug: "paciente-continuo", name: "Painel do Paciente Contínuo", description: "Veja o paciente único que atravessa SNA, Renal, Ácido-Base, Glicemia e Eletrofisiologia — cada módulo herda e influencia os vitais dos outros.", icon: Activity, category: "Fisiologia Humana" },
