...
const catalog: Record<string, NativeCase[]> = {
  ...
  "farmacoterapia-hemograma": [
    { index: 0, title: "Caso 1: Carla Souza", difficulty: "Fácil" },
    { index: 1, title: "Caso 2: Antônio Pereira", difficulty: "Médio" },
    { index: 2, title: "Caso 3: Fernanda Lima", difficulty: "Difícil" },
    { index: 3, title: "Caso 4: Rafael Mendes", difficulty: "Médio" },
    { index: 4, title: "Caso 5: Marcos Oliveira", difficulty: "Difícil" },
  ],
  "farmacoterapia-acido-base": [
    { index: 0, title: "Caso 1: João Santos", difficulty: "Médio" },
    { index: 1, title: "Caso 2: Maria Luiza", difficulty: "Fácil" },
    { index: 2, title: "Caso 3: Sebastião Gomes", difficulty: "Difícil" },
    { index: 3, title: "Caso 4: Paulo Roberto", difficulty: "Difícil" },
    { index: 4, title: "Caso 5: Teresa Alves", difficulty: "Médio" },
  ],
  "farmacoterapia-hepatopatia": [
    { index: 0, title: "Caso 1: Lucas Martins", difficulty: "Médio" },
    { index: 1, title: "Caso 2: Roberto Silva", difficulty: "Médio" },
    { index: 2, title: "Caso 3: Dona Aparecida", difficulty: "Difícil" },
    { index: 3, title: "Caso 4: Marcos Oliveira", difficulty: "Médio" },
    { index: 4, title: "Caso 5: Seu Joaquim", difficulty: "Difícil" },
  ],
  "farmacoterapia-renal": [
    { index: 0, title: "Caso 1: Carlos Eduardo", difficulty: "Médio" },
    { index: 1, title: "Caso 2: Dona Maria", difficulty: "Fácil" },
    { index: 2, title: "Caso 3: José Antônio", difficulty: "Difícil" },
    { index: 3, title: "Caso 4: Dona Francisca", difficulty: "Médio" },
    { index: 4, title: "Caso 5: Seu Benedito", difficulty: "Difícil" },
  ],
  "farmacoterapia-infeccao-lab": [
    { index: 0, title: "Caso 1: Pedro Almeida", difficulty: "Fácil" },
    { index: 1, title: "Caso 2: Ana Clara", difficulty: "Difícil" },
    { index: 2, title: "Caso 3: Juliana Fernandes", difficulty: "Fácil" },
    { index: 3, title: "Caso 4: Ricardo Campos", difficulty: "Difícil" },
    { index: 4, title: "Caso 5: Fátima Souza", difficulty: "Médio" },
  ],
  "farmacoterapia-dislipidemia": [
    { index: 0, title: "Caso 1: Carlos Mendes", difficulty: "Médio" },
    { index: 1, title: "Caso 2: Maria Teresa", difficulty: "Médio" },
    { index: 2, title: "Caso 3: Roberto Alves", difficulty: "Difícil" },
    { index: 3, title: "Caso 4: Antônio Ferreira", difficulty: "Difícil" },
    { index: 4, title: "Caso 5: Patrícia Lima", difficulty: "Difícil" },
  ],
  "farmacoterapia-glicemia": [
    { index: 0, title: "Caso 1: Maria Santos", difficulty: "Fácil" },
    { index: 1, title: "Caso 2: José Oliveira", difficulty: "Médio" },
    { index: 2, title: "Caso 3: Dona Fátima", difficulty: "Difícil" },
    { index: 3, title: "Caso 4: Pedro Lima", difficulty: "Difícil" },
    { index: 4, title: "Caso 5: Seu Antônio", difficulty: "Médio" },
  ],
  "farmacoterapia-coagulacao": [
    { index: 0, title: "Caso 1: Carlos Mendes", difficulty: "Médio" },
    { index: 1, title: "Caso 2: Dona Helena", difficulty: "Difícil" },
    { index: 2, title: "Caso 3: Amanda Rocha", difficulty: "Médio" },
