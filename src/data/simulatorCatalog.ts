...
// Simuladores nativos que existem no catálogo mas não fazem sentido como
// atividade atribuível em Sala Virtual (ex: exigem voz em tempo real, ou são
// um painel agregador de outros módulos, não um caso autocontido).
export const ROOM_EXCLUDED_SIMULATOR_SLUGS = new Set<string>([
  "paciente-ia-voz",
  "paciente-continuo",
]);
